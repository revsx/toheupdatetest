...
3. Add the renamed '**English.dat**' file to the '**Language**' folder located next to the '**template.dat**' file.  _To reload the language file in the game, use the **F5+t** hotkey._
